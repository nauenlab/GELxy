...
#KDC101. 
serial_no = str("27000001") #Change to match the serial number on your KDC. 
...
m_config.DeviceSettingsName = "PRMTZ8" # Chnage to whatever stage you are using. 
...
device.SetJogVelocityParams(1.0, 1.0)
device.SetJogStepSize(5.0)


#Switch LED on and Jog motor.
library.TLDC2200_setLedOnOff(devSession, True)
time.sleep(1)
device.MoveJog(MotorDirection.Forward, 2000) # (Direction of jog either .forward or .backward, int wait timeout)
