...
deviceY.SetJogStepSize(Decimal(1.0))
deviceY.SetJogVelocityParams(Decimal(0.1), Decimal(1.0))
deviceX.SetJogStepSize(Decimal(1.0))
deviceX.SetJogVelocityParams(Decimal(0.1), Decimal(1.0))

#Jog motor
deviceY.MoveJog(MotorDirection.Forward, 0) # (Direction of jog either .forward or .backward, int wait timeout)
