...
device.SetJogStepSize(Decimal(1.0))
device.SetJogVelocityParams(Decimal(0.1), Decimal(1.0))
...
# while (device.Status.IsInMotion == True):
...
while    (device.Status.IsInMotion == True): 
    ...
    # continue
    print ("LED on")
    print (device.Position_DeviceUnit )
else:
    print ("LED off")
